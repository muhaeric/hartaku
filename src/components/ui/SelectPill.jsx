  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <select
        ...
        className="h-10 w-full appearance-none truncate rounded-control border border-hairline bg-surface pl-3 pr-8 text-body font-medium text-ink dark:border-hairline-dark dark:bg-surface-dark dark:text-ink-dark"
      >
        {options.map((option) => (
